...
class LlamaWeightSimulator:
    ...
    def __init__(self, output_dir: str = None):
        ...
        if output_dir:
            ...
            self.output_dir = Path(tempfile.gettempdir()) / f"llama3_chunk_{os.getpid()}"
    ...
    def create_dummy_weights(self) -> Dict[str, Any]:
        ...
        # Para demo, criamos apenas algumas páginas para não lotar o disco
        demo_pages = 100
        for page_id in range(demo_pages):
        ...
        print(f"\n{Colors.CHECK} Estrutura criada: {demo_pages} páginas de teste criadas")
        print(f"{Colors.INFO} Registro salvo: {registry_path}{Colors.RESET}")
        
        return registry_data
    
    def register_with_chunk(self, chunk_root: Path = Path("/chunk")) -> bool:
...
class Llama3ChunkIntegration:
    ...
    def __init__(self):
        ...
        try:
            ...
            print(f"{Colors.WARN} NMM Kernel não encontrado localmente: {e}{Colors.RESET}")
    ...
    def _run_with_nmm(self, interactive: bool) -> None:
        ...
        if interactive:
                    ...
                    if cmd == "exit":
                        ...
                        for step in range(num_tokens):
                            ...
                            for layer in range(self.specs.LAYERS):
                                ...
                                # Acesso simulado aos pesos (1 página por camada para demo rápida)
            ...
            for token_idx in range(total_forward_passes):
                ...
                for layer in range(self.specs.LAYERS):
                    nmm.advance_layer(layer)
                    # Acessa a primeira página de cada camada
                    nmm.get_weights(layer, 0, self.specs.PAGE_SIZE_KB * 1024)
